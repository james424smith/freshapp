        ...
        if (types_1.isGraphQLScalarType(type)) {
            ...
            if (isArray) {
                ...
                if (!util_1.isNullOrUndefined(v) &&
                    v.some(function (e) { return util_1.isNullOrUndefined(e) ? isRequired_1 : typeof e !== jsType_1; })) {
                    var elemTypes = v.map(function (e) { return e === null ? 'null' : typeof e; }).join(',');
                    throw new Error("All elements in the " + name_1 + " array should be of type " + errorTypeText + ", [" + elemTypes + "] received. " + v);
                }
                if (validateScalar_1 &&
                    !util_1.isNullOrUndefined(v)) {
            ...
            else if (!util_1.isNullOrUndefined(v) && validateScalar_1 && !validateScalar_1(v)) {
